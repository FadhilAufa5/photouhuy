export default function About() {
  const features = [
    {
      ...
      description: "High-resolution captures with professional filters"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Adjust brightness, contrast, and apply stunning filters"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Strip Mode",
      description: "Create classic photo strips with 2-8 photos"
    }
  ];
  ...
  return (
    <section
      id="about"
      className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-b from-white to-gray-50"
    >
      <div className="w-full max-w-6xl">
        <div className="text-center space-y-4 mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">
            About PhotoboothUhuy
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            A modern, minimalist photo booth platform designed for capturing
            stunning moments with premium styling and elegant simplicity.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-violet-600 to-purple-600 rounded-3xl p-8 sm:p-10 lg:p-12 text-white text-center shadow-2xl">
          ...
          <p className="text-base sm:text-lg text-violet-100 mb-6 max-w-2xl mx-auto">
            Start capturing your moments with professional-quality filters and effects
          </p>
